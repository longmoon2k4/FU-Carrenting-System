...
-- Ensure Toyota and Ford producers exist (seed references them later)
IF NOT EXISTS (SELECT 1 FROM CarProducer WHERE ProducerName = 'Toyota Motor Corporation')
    INSERT INTO CarProducer (ProducerName, Address, Country) VALUES ('Toyota Motor Corporation', 'Toyota City, Aichi, Japan', 'Japan');
IF NOT EXISTS (SELECT 1 FROM CarProducer WHERE ProducerName = 'Ford Motor Company')
    INSERT INTO CarProducer (ProducerName, Address, Country) VALUES ('Ford Motor Company', 'Dearborn, MI, USA', 'USA');
GO
...
-- set image urls for these new cars (only when present)
UPDATE Car SET ImageUrl = '/img/cars/honda-civic.svg' WHERE CarName = 'Honda Civic' AND CarModelYear = 2020 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/honda-accord.svg' WHERE CarName = 'Honda Accord' AND CarModelYear = 2021 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/hyundai-elantra.svg' WHERE CarName = 'Hyundai Elantra' AND CarModelYear = 2019 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/hyundai-santafe.svg' WHERE CarName = 'Hyundai Santa Fe' AND CarModelYear = 2022 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/kia-sportage.svg' WHERE CarName = 'Kia Sportage' AND CarModelYear = 2020 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/kia-carnival.svg' WHERE CarName = 'Kia Carnival' AND CarModelYear = 2021 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/nissan-altima.svg' WHERE CarName = 'Nissan Altima' AND CarModelYear = 2018 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/nissan-xtrail.svg' WHERE CarName = 'Nissan X-Trail' AND CarModelYear = 2021 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/chevrolet-malibu.svg' WHERE CarName = 'Chevrolet Malibu' AND CarModelYear = 2019 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/toyota-corolla.svg' WHERE CarName = 'Toyota Corolla' AND CarModelYear = 2020 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/toyota-rav4.svg' WHERE CarName = 'Toyota RAV4' AND CarModelYear = 2021 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/ford-mustang.svg' WHERE CarName = 'Ford Mustang' AND CarModelYear = 2022 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/ford-explorer.svg' WHERE CarName = 'Ford Explorer' AND CarModelYear = 2019 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/mazda-cx5.svg' WHERE CarName = 'Mazda CX-5' AND CarModelYear = 2020 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/subaru-forester.svg' WHERE CarName = 'Subaru Forester' AND CarModelYear = 2021 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/bmw-3series.svg' WHERE CarName = 'BMW 3 Series' AND CarModelYear = 2019 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/mercedes-cclass.svg' WHERE CarName = 'Mercedes C-Class' AND CarModelYear = 2020 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/suzuki-swift.svg' WHERE CarName = 'Suzuki Swift' AND CarModelYear = 2018 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/mitsubishi-outlander.svg' WHERE CarName = 'Mitsubishi Outlander' AND CarModelYear = 2021 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/vw-golf.svg' WHERE CarName = 'Volkswagen Golf' AND CarModelYear = 2019 AND ImageUrl IS NULL;
...
UPDATE Car SET ImageUrl = '/img/cars/audi-a4.svg' WHERE CarName = 'Audi A4' AND CarModelYear = 2020 AND ImageUrl IS NULL;
